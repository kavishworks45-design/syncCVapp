    ...
    return (
        <>
            <motion.div
                ...
                className="zenith-sidebar desktop-sidebar"
                style={{
                    width: "280px",
            ...
            <div className="mobile-visible" style={{
                ...
                height: "80px", background: "rgba(255,255,255,0.95)", backdropFilter: "blur(20px)",
                borderTop: "1px solid rgba(0,0,0,0.1)",
                zIndex: 9999, padding: "0 24px",
                justifyContent: "space-between", alignItems: "center", boxShadow: "0 -4px 20px rgba(0,0,0,0.05)"
            }}>
                <MobileNavItem icon={FaHome} label="Home" active={isActive('overview')} onClick={() => navigate('/dashboard')} />
                <MobileNavItem icon={FaChartPie} label="Tracker" active={isActive('tracker')} onClick={() => navigate('/tracker')} />

                <div style={{ width: "56px", height: "56px", background: "#0f172a", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", marginTop: "-30px", boxShadow: "0 10px 25px rgba(15, 23, 42, 0.4)", cursor: "pointer", border: "4px solid rgba(255,255,255,0.2)" }} onClick={() => navigate('/builder')}>
                    <FaRocket color="white" size={22} />
                </div>

                <MobileNavItem icon={FaSearch} label="Jobs" active={isActive('jobs')} onClick={() => navigate('/jobs')} />
                <MobileNavItem icon={FaCog} label="Settings" active={isActive('settings')} onClick={() => navigate('/settings')} />
            </div>
        </>
    );
}
...
const MobileNavItem = ({ icon: Icon, label, active, onClick }) => (
    <div onClick={onClick} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", color: active ? "#0f172a" : "#94a3b8", cursor: "pointer", width: "60px" }}>
        <Icon size={20} />
